...
<header> <!--Header avec la navbar-->
    <nav class="navbar navbar-expand-lg navbar-light #d1ccb0">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><img src="assets/images/logo.png" class="logo img-fluid" alt="logo pokémon"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a class="nav-link" href="https://www.google.fr/"><i class="bi bi-playstation"></i></a>
            <a class="nav-link" href="https://www.google.fr/"><i class="bi bi-xbox"></i></a>
          <a class="nav-link" href="https://www.google.fr/"><i class="bi bi-steam"></i></a>
